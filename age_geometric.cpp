...
{
    VertexData vertices[] ={
        {QVector3D(0,0,0),QVector2D((double)m_leftTopX/(double)m_imageWidth , (double)m_leftTopY/(double)m_imageHeight)},
        {QVector3D(m_width,0,0),QVector2D((double)m_rightBottonX/(double)m_imageWidth , (double)m_leftTopY/(double)m_imageHeight)},
        {QVector3D(m_width,m_height,0),QVector2D((double)m_rightBottonX/(double)m_imageWidth,(double)m_rightBottonY/(double)m_imageHeight)},
        {QVector3D(0,m_height,0),QVector2D((double)m_leftTopX/m_imageWidth,(double)m_rightBottonY/m_imageHeight)}
    };
